...
import 'package:photo_filter_app/Screens/Adjustment Screen/adjust_editor.dart';
              ...
              Padding(
                ...
                child: IconButton(
                  onPressed: () async {
                    ...
                    final imageFile = appProvider.imageFile;

                    if (imageFile != null && await imageFile.exists()) {
                      // Convert the image file to an XFile
