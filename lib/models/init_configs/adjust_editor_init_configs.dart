...
/// Configuration class for initializing the adjustment editor.
///
class AdjustmentEditorInitConfigs extends EditorInitConfigs {
  /// Creates a new instance of [AdjustmentEditorInitConfigs].
  ///
