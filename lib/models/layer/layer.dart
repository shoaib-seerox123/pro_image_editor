...
/// A class representing adjustment layer data, including properties
/// for brightness, contrast, and temperature adjustments.
class AdjustmentLayerData extends Layer {
  /// Creates an instance of AdjustmentLayerData.
  ///
  /// The [brightness], [contrast], and [temperature] parameters are required,
  ...
  /// Factory constructor for creating an AdjustmentLayerData instance from a
  /// Layer and a map.
  factory AdjustmentLayerData.fromMap(Layer layer, Map<String, dynamic> map) {
    return AdjustmentLayerData(
      ...
      rotation: layer.rotation,
      scale: layer.scale,
      brightness: safeParseDouble(map['brightness'], fallback: 0.0),
      contrast: safeParseDouble(map['contrast'], fallback: 1.0),
      temperature: safeParseDouble(map['temperature'], fallback: 0.0),
    );
  }

  /// The brightness adjustment level.
  final double brightness;

  /// The contrast adjustment level.
  final double contrast;

  /// The temperature adjustment level.
