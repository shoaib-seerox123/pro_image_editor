...
import 'package:pro_image_editor/models/theme/theme_adjust_editor.dart';
// Project imports:
...
class ImageEditorTheme {
  ...
  const ImageEditorTheme({
    ...
    this.adjustmentEditorTheme = const AdjustmentEditorTheme(),
  ...
  final AdjustmentEditorTheme adjustmentEditorTheme;
